  ...
  async onNodeInit({ zclNode }) {
    ...
    if (this.hasCapability('windowcoverings_set')) {
      ...
      this.registerCapabilityListener('windowcoverings_set', async value => {
        ...
        await zclNode.endpoints[10].clusters[CLUSTER.WINDOW_COVERING.NAME].goToLiftPercentage({
      ...
      */
      ...
      // Get Position
      // zclNode.endpoints[10].clusters[CLUSTER.ANALOG_OUTPUT.NAME]
      //  .on('attr.presentValue', this.onCurtainPositionAttrReport.bind(this));

      // Get Position
      zclNode.endpoints[10].clusters[CLUSTER.WINDOW_COVERING.NAME]
        .on('attr.currentPositionLiftPercentage', this.onCurtainPositionAttrReport.bind(this));
    }

    // Register the AttributeReportListener - Lifeline
    zclNode.endpoints[10].clusters[XiaomiBasicCluster.NAME]
