...
// The module exposes a single functional endpoint that holds both the
...
class VimarOnOffSwitchModule extends ZigBeeDevice {
  ...
  onDeleted() {
    this.log('VimarOnOffSwitchModule removed');
  }

}

module.exports = VimarOnOffSwitchModule;
